...
doc:
	echo '<!DOCTYPE html><html><head><meta charset="utf-8"><title>Pásmový ekvalizátor</title></head><body>' > README.html && perl Markdown/Markdown.pl README.md >> README.html && echo '</body></html>' >> README.html
